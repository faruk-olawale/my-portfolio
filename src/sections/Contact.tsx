...
export const ContactSection = () => {
  ...
  <div className="py-16 pt-12 lg:py-24 lg:pt-20">
    ...
    <div>
    <h2 className="font-serif text-2xl md:text-3xl">et&apos;s create something amazing together</h2>
    <p className="text-sm md:text-base mt-2">Ready to bring next project to life? Let&apos;s connect and 
