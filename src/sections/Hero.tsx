  ...
  return (
    ...
    <div className="absolute inset-0 -z-30 opacity-5" style={{
      backgroundImage:`url(${grainImage.src})`,
       ...
       ></div>
       <div className=" size-[620px] hero-item"></div> 
       <div className=" size-[820px] hero-item"></div> 
       ...
       <HeroOrbit size={550} rotation={98}>
        ...
        <HeroOrbit size={430} rotation={79}>
         ...
         <HeroOrbit size={650} rotation={-51}>
         ...
         <p className="mt-4 text-center text-white/68 md:text-lg">
          Engineering next-generation user experiences into resilient,
